...
BASE_CMD="python test_cv.py trainer=default trainer.gpus=1 experiment_name=$dataset model.train_size=$train_size datamodule.csv_path=$data run_csv_path=$run_csv_path"
BASE_MODEL="_model"
