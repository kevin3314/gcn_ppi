...
from src.models.modules.mm_with_bert_model import MultiModalBertModel

logger = logging.getLogger(__name__)
logger.setLevel(logging.INFO)


class MultiModalWithBertModule(LightningModule):
    def __init__(
        self,
        ...
        self.model: MultiModalBertModel = MultiModalBertModel(
            amino_vocab_size, node_dim, num_gnn_layers, pretrained_path
        )
